...
execute as @a at @s if entity @e[type=item_display,tag=gcegames.collectable,distance=..0.7] as @e[type=item_display,sort=nearest,limit=1] run function gcegames:collect
