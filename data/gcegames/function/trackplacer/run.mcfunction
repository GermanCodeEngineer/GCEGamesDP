...
execute if block ~ ~ ~ grey_glazed_terracotta[facing=?] run teleport @s ~ ~1 ~
execute if block ~ ~ ~ grey_glazed_terracotta[facing=?] run teleport @s ~ ~-1 ~
execute unless block ~ ~ ~ magenta_glazed_terracotta unless block ~ ~ ~ lime_glazed_terracotta run function gcegames:trackplacer/kill
