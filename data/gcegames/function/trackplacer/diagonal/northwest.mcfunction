rotate @s 135.0 0
fill ~1 ~4 ~-3 ~1 ~4 ~-3 crimson_fence replace #replaceable
fill ~2 ~4 ~-3 ~2 ~4 ~-3 crimson_fence replace #replaceable
...
fill ~-3 ~4 ~2 ~-3 ~4 ~2 crimson_fence replace #replaceable
fill ~-3 ~4 ~1 ~-3 ~4 ~1 crimson_fence replace #replaceable
